...
export default function CreateRoomPage() {
  ...
  // Watch for room creation response and redirect to lobby
  useEffect(() => {
    if (room && room.roomId) {
          ...
          <div className="flex flex-col gap-8 animate-fadeIn">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  >
                    ...
                    <span className="text-[11px] text-[var(--ink-tertiary)] mt-0.5">
                      {lvl.desc}
                    </span>
                  </button>
                ))}
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xs text-[var(--ink-tertiary)]">Min 3</span>
              </div>
